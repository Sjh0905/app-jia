// 增加了 props.bulletsLength属性 用来修改下面有按钮的时候按钮数目问题
...
export default class Carousel extends Component {
  static propTypes = {
    ...
    bulletsFirstContainerStyle: Text.propTypes.style,
  ...
  static defaultProps = {
    ...
    bulletsFirstContainerStyle: undefined,
  ...
  _renderBullets = (pageLength) => {
    ...
    return (
      <View style={[styles.bullets, this.props.bulletsContainerStyle]} pointerEvents="box-none">
          <View style={[styles.bulletsFirst, this.props.bulletsFirstContainerStyle]}>
              {bullets}
          </View>
      </View>
    );
  ...
  render() {
    ...
    return (
      <View {...containerProps}>
        ...
        {this.props.bullets && this._renderBullets(this.props.bulletsLength || this.state.childrenLength)}
