...
@observer
export default class HeatRecordsItem extends RNComponent {
    ...
    getFundList = function () {
        ...
        this.$http.send("GET_WEEK_REWARD", {
            bind: this,
            query:{},
    ...
    goToFundDetail = (item,fundType) => {
        ...
        this.$router.push('HeatRecordsDetail', {item,fundType,fundStatus})
    ...
    _renderFundRecordsItem = ({item, index}) => {
        ...
        let fundType = item.rewType == 2 ? '双周热度奖' : '单周热度奖'
