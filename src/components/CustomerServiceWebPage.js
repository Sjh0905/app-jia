...
import {View, WebView, Text, Keyboard, Platform} from 'react-native';
...
export default class App extends RNComponent {
    ...
    constructor() {
        ...
        // this.url = 'https://www.eunex.group/';
        ...
        console.log('this is CustomerServiceWebPage renderUrl',this.renderUrl);
    }
    ...
    _keyboardDidShow (e) {
        ...
        this.ScreenHeight = DeviceHeight2 - e.endCoordinates.height
    }

    _keyboardDidHide (e) {
        // this.setState({webViewHeight:ScreenHeight})
        this.ScreenHeight = DeviceHeight2
    }
    ...
    render() {
        return (
            <View style={[{height:this.ScreenHeight,flexDirection: 'column-reverse',backgroundColor:StyleConfigs.navBgColor0602,paddingTop: getDeviceTop()}]}>
                {/*加载中*/}
                {
