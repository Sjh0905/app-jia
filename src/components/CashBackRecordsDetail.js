...
@observer
export default class CashBackRecordsDetail extends RNComponent {
        ...
        return (
            <View style={[styles.itemBox]}>
                ...
                <View style={[styles.itemDetailBox]}>
                    ...
                    <Text allowFontScaling={false}
                        style={[styles.itemDetail, baseStyles.text0D0E23]}>{this.$globalFunc.formatDateUitl(item.sendTime, 'YYYY-MM-DD hh:mm:ss')}</Text>
                </View>
                {/*日期 end*/}
