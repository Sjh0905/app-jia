        ...
        /*return (
            <View style={[styles.container, baseStyles.container]}>
                ...
                <View style={styles.box}>
                    <View>
                        <View><Text style={styles.textTip} allowFontScaling={false}>证件拍摄须知</Text></View>
                    ...
                    <View style={[styles.itembox]}>
                            <Image source={EdgeAngleIntegrity} style={styles.icon} resizeMode={'stretch'}/>
                        <View style={[styles.itemLeft]}>
                            <View><Text style={styles.textOne} allowFontScaling={false}>边角完整</Text></View>
                            <View><Text style={styles.textTwo} allowFontScaling={false}>确认证件完全处于图片内</Text></View>
                        </View>
                    </View>
                    <View style={[styles.itembox]}>
                            <Image source={clearfont} style={styles.icon} resizeMode={'stretch'}/>
                        <View style={[styles.itemLeft]}>
                            <View><Text style={styles.textOne} allowFontScaling={false}>字体清晰</Text></View>
                            <View><Text style={styles.textTwo} allowFontScaling={false}>保证精准对焦，使证件上</Text></View>
                            <View><Text style={styles.textTwo} allowFontScaling={false}>文字和照片清晰可见</Text></View>
                        </View>
                    </View>

                    <View style={[styles.itembox]}>
                            <Image source={LuminanceuniformityTip} style={ styles.icon} resizeMode={'stretch'}/>
                        <View style={[styles.itemLeft]}>
                    ...
                    <View style={[styles.itembox]}>
                        <Image source={notTooBig} style={styles.icon} resizeMode={'stretch'}/>
                        <View style={[styles.itemLeft]}>
                            <View><Text style={styles.textOne} allowFontScaling={false}>不得过大</Text></View>
                            <View><Text style={styles.textTwo} allowFontScaling={false}>图片不超过2M</Text></View>
                        </View>
                    </View>
