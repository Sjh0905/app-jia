...
export default class extends Component {
    ...
    renderNextButton = () => {
        ...
        if (this.props.loop ||
            this.state.index !== this.state.total - 1) {
            button = this.props.nextButton || <Text allowFontScaling={false} style={styles.buttonText}>›</Text>
        }
    ...
    renderPrevButton = () => {
        ...
        if (this.props.loop || this.state.index !== 0) {
            button = this.props.prevButton || <Text allowFontScaling={false} style={styles.buttonText}>‹</Text>
        }
