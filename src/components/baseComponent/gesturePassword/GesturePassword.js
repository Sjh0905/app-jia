...
var padding = 3,arrowRate = 3.6,gestureAreaLength = 270;

if(PlatformOS == "ios"){
    padding = 2,arrowRate = 3.6,gestureAreaLength = 280;
    PlatformiOSPlus && (padding = 2,arrowRate = 3.7,gestureAreaLength = 310);
}
...
// const gestureAreaLength = (PlatformOS == "ios" && PlatformiOSPlus) && 310 || 270;

const {width: deviceWidth, height: deviceHeight} = Dimensions.get('window')

export default class GesturePassword extends RNComponent {

    static defaultProps = {
        lineWidth: 1,
        pointBackgroundColor: 'transparent',
        gestureAreaLength: gestureAreaLength,
        gestureAreaTop: 0,
        color: 'transparent',//point边框颜色
        // lineColor: '#A9A9A9',//连接线的颜色
    ...
    static propTypes = {
        ...
        gestureAreaTop: PropTypes.number,
            ...
            <View style={[this.props.style, styles.container]}>
                ...
                <View
                    ...
                    style={{
                        ...
                        marginHorizontal: this._gestureAreaMarginHorizontal,//控制水平居中
                        // backgroundColor:'#aaa'
                    }}>
                    {this._renderLines()}
                    {this._renderPoints()}
    ...
    _onLayout = (e) => {
        ...
        this._gestureAreaTop = e.nativeEvent.layout.y+this.props.gestureAreaTop
    ...
    _renderArrows () {
        return this.state.arrows.map((arrow, index) => {
            ...
            return (
                <Arrow
                    key={'arrow-' + index}
                    width={this._pointRadius / arrowRate}
                    color={arrow.color}
                    start={{
